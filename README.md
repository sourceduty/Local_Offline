...
| Sustained Performance               | Medium (mobile thermals, may throttle)                        | High (server-grade, stable multithreaded loads)         | Very High (high performance with 96 cores and NVIDIA RTX™ 6000 Ada Generation GPU) |
| Max Token Context Window           | ~2K–3K tokens (limited by RAM)                                | 4K–8K tokens (ample RAM)                               | 8K–12K tokens (ample RAM)                                   |
| Power Efficiency                    | High (mobile chip, efficient per watt)                        | Low (high power draw, higher sustained output)         | Medium (higher power consumption due to 96 cores and GPU)  |
